CREATE TABLE `data`
(
    `etag`         VARCHAR(200) UNIQUE PRIMARY KEY NOT NULL COMMENT 'ETag representing this data being unique. Used for updating idcache.',
...
ALTER TABLE `data`
    COMMENT = 'Cached resource for keep tracking data dump updates (either being monthly or random occations)';
